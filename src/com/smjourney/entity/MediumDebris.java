...
/**
 * Medium-sized debris with a size of 2.
 */
public class MediumDebris extends Debris
{
	
	private BufferedImage sprite;
	
	/**
	 * Constructs medium-sized debris with a size of 2 and an armor durability of 100.
	 */
	public MediumDebris()
	{
		super(2);
		setEntityID(Entity.MEDIUMDEBRIS);
	...
	public void updateSprite()
	{
		try { sprite = ImageIO.read(new File("res/Debris (Medium) (Scaled).png")); } catch (Exception e) {
			Main.errorStream.println("Debris (Medium) could not be loaded");
		}
	}
